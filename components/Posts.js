...
const Posts = ({id,post,postIsPage}) => {
    ...
    return (
        <div className='p-3 flex cursor-pointer border-b border-gray-700 scrollbar-hide' onClick={()=> router.push(`${id}`)}>
            {!postIsPage && (<img src={post?.userImg} alt="" className="h-11 w-11 rounded-full mr-4"/>)}
            <div className='flex flex-col space-y-2 w-full'>
                <div className={`flex ${!postIsPage && "justify-between"}`}>
                    {postIsPage && (
                    ...
                    {/* flex shrink is used as an object contain where the size or anything stays proper ! like an object contain */}
                    <div className={`icon group flex-shrink-0 ${postIsPage && "ml-auto"}`}>
                ...
                {/* to not mess up your border radius you use object cover instead of object contain */}
                <img src={post?.image} className='rounded-2xl max-h-[700px] object-cover mr-2'/>
                <div className={`text-[#6e767d] flex justify-between w-10/12 ${postIsPage && 'mx-auto'}`}>
                        <div
                        ...
                        <div
                            ...
                            <div className="icon group-hover:bg-pink-600/10">
                                {liked ? (
                                    <EyeIcon className="h-5 text-pink-600" />
                                ) : (
